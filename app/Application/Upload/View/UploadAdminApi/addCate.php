...
//                mixins: [window.__methods,window.__filters],
                ...
                methods: {
                    ...
                    getDetail: function () {
                        var that = this;
                        var url = '{:U("Upload/UploadAdminApi/getDetail")}';
                        var data = {cate_id:that.cate_id};
                    ...
                    confirm: function () {
                        var that  = this;
                        $.ajax({
                            url: "{:U('Upload/UploadAdminApi/saveCate')}",
                            data: {cate_id:that.cate_id,cate_name:that.cate_name},
                            dataType: 'json',
                            type: 'post',
